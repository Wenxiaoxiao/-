  ...
  <div class="consult-index-detail">
    <div class="top-head">
      ...
      <div class="right-des">
        ...
        <div class="txt">状态：{{type==0?'已就诊':type==1?'待就诊':type==2?'已取消':''}}</div>
      </div>
    </div>
    <div class="userInfos">
      ...
      <div class="txt">姓名：XXXX</div>
      <div class="txt">手机号：XXX-XXXX-XXXX</div>
      <div class="txt">备注：XXXXXXXXXXXXX</div>
          ...
          children: [
            {
              q: "1.问题1XXXXXXXXXXX?",
              a:
                "文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文..."
            },
            {
              q: "2.问题2XXXXXXXXXXX?",
              a:
      ...
      flexible: [
        {
          ...
          content:
            "文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字文字1.文字文字文字文字文字文字文字文字文字文字2.文字文字文字文字文字文字文字文字文字文字"
        },
        {
          title: "留档报告",
