<template>
  <div class="conceptDetail">
    ...
    <br />
    <br />所以“顺其自然”整句话可以翻译为：把症状以及负面情绪的产生当做是一种自然的状态，来了就来了。对于有症状的人来说，产生症状就是一种自然，而对于没有症状的人，不产生症状就是一种自然，每个人的自然是不
    <img
      src="@static/images/concept.png"
      alt
    />
    一样的。总得来说，既然能够出现，那么这就是一种自然，不管你是出现症状，或者是不出现症状，这都是一种自然，是一种存在即有理，有理即安心的状态。
